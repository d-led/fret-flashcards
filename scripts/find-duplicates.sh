...
JSCPD_IGNORE="**/node_modules/**,**/dist/**,**/coverage/**,**/.cache/**,**/.git/**,**/.vscode-test/**,packages/code-commentray-static/site/**,*.vsix,.yarn/**,**/ios/**,**/test-results/**,**/cypress/**,scripts/app-store-prep.js,scripts/remove-submission.js"
