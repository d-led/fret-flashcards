...
describe("TouchHandler", () => {
  ...
  describe("Event Prevention", () => {
    it("should prevent context menu on long press", () => {
      ...
      const contextMenuCall = mockAddEventListener.mock.calls.find((call) => call[0] === "contextmenu");
    ...
    it("should prevent text selection during touch", () => {
      ...
      const selectStartCall = mockAddEventListener.mock.calls.find((call) => call[0] === "selectstart");
